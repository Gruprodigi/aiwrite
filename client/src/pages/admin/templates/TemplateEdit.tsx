...
export default function TemplateEdit() {
  ...
  const [name, setName] = useState("Boas-vindas");
  const [subject, setSubject] = useState("Bem-vindo ao WriterAI");
  const [htmlContent, setHtmlContent] = useState("<h1>Bem-vindo!</h1>");
  const [variables, setVariables] = useState<string[]>(["{{name}}", "{{email}}"]);
  ...
  return (
    <AdminLayout title="Editar Template de Email">
