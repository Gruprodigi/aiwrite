...
export default function PaymentHistory() {
  ...
  useEffect(() => {
    document.title = "Histórico de Pagamentos - WriterAI";
  }, []);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Visualize e gerencie todos os seus pagamentos</p>
        </div>
        ...
        <Card className="p-6 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-green-600">R$ 199,50</p>
            </div>
            <div>
              <p className="text-sm text-gray-600 mb-1">Último Pagamento</p>
              <p className="text-2xl font-bold text-gray-900">20/12/2025</p>
            </div>
            <div>
              <p className="text-sm text-gray-600 mb-1">Próxima Renovação</p>
              <p className="text-2xl font-bold text-primary">20/01/2026</p>
            </div>
          </div>
        </Card>
