<div>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <p class="mb-0">{{ __('Here you can edit this page for your website.') }}</p>
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ route('admin.page.index') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center p-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-list-check" viewBox="0 0 16 16">
                  ...
                  <span class="ml-2">{{ __('Manage Page') }}</span>
    ...
    <div>
        <div class="col-lg-12">
            <div class="card card-body border-0 shadow mb-4">
                <h2 class="h5 mb-4">{{ __('Edit Page') }}</h2>
                <form wire:submit.prevent="update({{ $page->id }})">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <div>
                                ...
                                <select wire:model.lazy="status" id="status" class="form-control">
                                    <option {{ $page->status == 'approved' ? 'selected' : '' }} value="approved">{{ __('Approved') }}</option>
                                    <option {{ $page->status == 'pending' ? 'selected' : '' }} value="pending">{{ __('Pending') }}</option>
                                </select>
