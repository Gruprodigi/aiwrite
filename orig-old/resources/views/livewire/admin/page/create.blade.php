    ...
    <div>
        <div class="col-lg-12">
            <div class="card card-body border-0 shadow mb-4">
                <h2 class="h5 mb-4">{{ __('Create New Page') }}</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <div wire:ignore>
                                ...
                                <textarea wire:model.lazy="description" id="description" cols="30" rows="10" class="form-control h-250 @error('description') error @enderror"></textarea>
