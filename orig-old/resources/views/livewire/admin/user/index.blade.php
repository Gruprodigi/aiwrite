<div>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <p class="mb-0">{{ __('Show All User List') }}</p>
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ route('admin.user.create') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
                    ...
                    <tr>
                        <td>
                            <div class="form-check dashboard-check">
                                <input class="form-check-input" type="checkbox" wire:model="checklistId" value="{{ $user->id }}" />
                            </div>
                        </td>
                        <td>
                            <span class="fw-bold">{{ $user->name }}</span>
                        </td>
                        <td><span class="fw-blod">{{ $user->email }}</span></td>
                        <td><span class="fw-normal">{{ $user->created_at->isoFormat('ll') ?? '' }}</span></td>
                        <td>
                        ...
                        <td>
                            <div class="btn-group text-center">
                                ...
                                <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1" >
                                    <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.user.edit',$user->id) }}">
