<div>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">{{ __('Create New User') }}</h2>
            <p class="mb-0">{{ __('Here you can add your new user.') }}</p>
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ route('admin.user.index') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center p-2">
    ...
    <div>
        <div class="col-lg-12">
            <div class="card card-body border-0 shadow mb-4">
                <h2 class="h5 mb-4">{{ __('Create New User') }}</h2>
