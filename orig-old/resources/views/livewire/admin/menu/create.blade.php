<div>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">{{ __('Create Menu') }}</h2>
            <p class="mb-0">{{ __('Here you can create a new Menu for your website.') }}</p>
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ route('admin.menu.index') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center p-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-list-check" viewBox="0 0 16 16">
                  ...
                  <span class="ml-2">{{ __('Manage Menu') }}</span>
            </a>
        </div>
    </div>
    <div>
        <div class="col-lg-12">
            <div class="card card-body border-0 shadow mb-4">
                <h2 class="h5 mb-4">{{ __('Create New Menu') }}</h2>
                <form wire:submit.prevent="store">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <div>
                                <label for="position">{{ __('Select Position') }}</label>
                                <select wire:model="position" id="position" class="form-control">
                                    <option value="header">{{ __('Header Menu') }}</option>
                                    <option value="footer_first">{{ __('Footer First Menu') }}</option>
                                    <option value="footer_second">{{ __('Footer Second Menu') }}</option>
                                    <option value="footer_third">{{ __('Footer Third Menu') }}</option>
                                    <option value="footer_four">{{ __('Footer Four Menu') }}</option>
                                </select>
