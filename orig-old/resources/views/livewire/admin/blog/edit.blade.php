<div>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">{{ __('Edit Blog') }}</h2>
            <p class="mb-0">{{ __('Here you can edit this blog for your website.') }}</p>
        </div>
    ...
    <div>
        <div class="col-lg-12">
            ...
            x-on:livewire-upload-progress="progress = $event.detail.progress">
                <h2 class="h5 mb-4">{{ __('Edit Blog') }}</h2>
                <form wire:submit.prevent="update({{ $blog->id }})">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <div>
                                ...
                                <input class="form-control @error('image') error @enderror" id="image" type="file" wire:model="image" />
                        ...
                        <div class="col-md-12 mb-3">
                            <div>
                                ...
                                <select wire:model.lazy="status" id="status" class="form-control">
                                    <option {{ $blog->status == 'approved' ? 'selected' : '' }} value="approved">{{ __('Approved') }}</option>
                                    <option {{ $blog->status == 'pending' ? 'selected' : '' }} value="pending">{{ __('Pending') }}</option>
                                </select>
