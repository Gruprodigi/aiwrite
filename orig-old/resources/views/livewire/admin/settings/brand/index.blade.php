        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('brand List') }}</li>
                </ol>
            </nav>
            <h2 class="h4">{{ __('Brand List') }}</h2>
            <p class="mb-0">{{ __('Show All brand List') }}</p>
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ route('admin.brand.create') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-9 col-lg-8 d-md-flex">
                <div class="input-group me-2 me-lg-3 fmxw-300">
                    ...
                    <input type="text" class="form-control" wire:model="search" placeholder="Search brands" />
                </div>
                    ...
                    <tr>
                        <td>
                            <div class="form-check dashboard-check">
                                <input class="form-check-input" type="checkbox" wire:model="checklistId" value="{{ $brand->id }}" />
                            </div>
                        </td>
                        <td>
                            <img width="130" src="{{ Storage::url('brand/'.$brand->name) }}" alt="">
                        </td>
                        <td><span class="fw-normal">{{ $brand->created_at->isoFormat('ll') }}</span></td>
                        <td>
                        ...
                        <td>
                            <div class="btn-group text-center">
                                ...
                                <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                    <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.brand.edit',$brand->id) }}">
