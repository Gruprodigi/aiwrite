<div>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">{{ __('Plan List') }}</h2>
            <p class="mb-0">{{ __('Show All Plan List') }}</p>
        </div>
        <div class="btn-toolbar mb-2 mb-md-0">
            <a href="{{ route('admin.plan.create') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
        ...
        <div class="row justify-content-between align-items-center">
            <div class="col-9 col-lg-8 d-md-flex">
                <div class="input-group me-2 me-lg-3 fmxw-300">
                    ...
                    <input type="text" class="form-control" wire:model="search" placeholder="Search Plan" />
                </div>
                    ...
                    <tr>
                        <td>
                            <div class="form-check dashboard-check">
                                <input class="form-check-input" type="checkbox" wire:model="checklistId" value="{{ $plan->id }}" />
                            </div>
                        </td>
                        ...
                        <td>
                            <span class="fw-normal">{{ $currency }}{{ $plan->price }}</span>
                        </td>
                        <td><span class="fw-normal">{{ $plan->created_at->isoFormat('ll') }}</span></td>
                        <td>
                        ...
                        <td>
                            <div class="btn-group text-center">
                                ...
                                <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                    <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.plan.edit',$plan->id) }}">
